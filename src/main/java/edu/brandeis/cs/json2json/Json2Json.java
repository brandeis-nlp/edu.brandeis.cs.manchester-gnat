...
//        System.out.println("Evaluate:\n" + sb.toString());
    ...
    private static String filterXml(String dsl, String root, Collection<String> leaves) {
        ...
        dsl = dsl.replaceAll("\\.foreachWithIndex\\s*\\{",".collectWithIndex{");
...
//        System.out.println(json2xml(json.toString()));
        ...
        String dsl = IOUtils.toString(Json2Json.class.getResourceAsStream("/edu.brandeis.cs.manchester.gnat.GnatWS.dsl"));
        String xml = "<text id=\"UnknownId\" xref=\"UserQuery\">\n" +
                ...
                "</annotations>\n" +
                "</text>";
        System.out.println(Json2Json.xml2jsondsl(xml, dsl));
    }
